...
app.use(cors((req, callback) => {
  if (req.path.startsWith('/api/platforms/')) {
    ...
    callback(null, { origin: ['https://256newsroom.com', 'https://www.256newsroom.com', 'http://localhost:5066', 'http://127.0.0.1:5066'], credentials: true });
  }
}));
...
// API (auth-protected upload/list) + public file/watch paths under /media/*
